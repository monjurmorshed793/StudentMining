...
import { OrderPurchaseComponent } from 'app/entities/order-purchase/order-purchase.component';
...
describe('Component Tests', () => {
    describe('OrderPurchase Management Component', () => {
        let comp: OrderPurchaseComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(OrderPurchaseComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.orderPurchases[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
